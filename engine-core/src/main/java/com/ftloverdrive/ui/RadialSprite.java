...
/**
 * An implementation of Drawable that allows drawing of a part of the texture in a gauge-like way.
 * 
 * @author Xoppa - https://github.com/xoppa/world/blob/master/src/com/xoppa/android/misc/RadialSprite.java
 */
